export const educationHeader_1 = [
...
export const educationHeader_2 = [
...
export const educationData = [
    { factor: 'Secondary school (high school) credential or less', point: 0, point2: 0 },
    { factor: 'Post-secondary program credential of one year or longer', point: 13, point2: 25 },
    { factor: 'Two or more post-secondary program credentials AND at least one of these credentials was issued on completion of a post-secondary program of three years or longer', point: 25, point2: 50 },
];

export const fweData = [
    { factor: 'No foreign work experience', point: 0, point2: 0 },
    { factor: '1 or 2 years of foreign work experience', point: 13, point2: 25 },
    { factor: '3 years or more of foreign work experience', point: 25, point2: 50 },
];

export const coqData = [
    { factor: 'With a certificate of qualification', point: 25, point2: 50 },
];
